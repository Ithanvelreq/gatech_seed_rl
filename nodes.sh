...
docker run --entrypoint ./docker/my_run.sh -ti -it -p 6006-6015:6006-6015 --network=host -e HOST_PERMS="$(id -u):$(id -g)" --name seed --rm seed_rl:$ENVIRONMENT $ENVIRONMENT $AGENT $NUM_ACTORS $ENV_BATCH_SIZE $@
