...
from seed_rl.crawler import env
...
flags.DEFINE_string('gin_config', '/seed_rl/crawler/gin/ppo.gin', 'A path to a config file.')
flags.DEFINE_multi_string('gin_bindings', [],
                          'Newline separated list of Gin parameter bindings.')
flags.DEFINE_boolean("headless", True, "Run in headless mode")
flags.DEFINE_boolean("add_noise", False, "Add noise to observations")
flags.DEFINE_boolean("add_bias", False, "Add bias to observations")
flags.DEFINE_boolean("random_orient", False, "Start crawler with random heading") 
...
def main(unused_argv):
  ...
  create_environment = lambda task, config: env.create_environment(FLAGS.headless, FLAGS.add_noise, FLAGS.add_bias, FLAGS.random_orient)
